        ...
        public static function quote()
	{
		return Collection::make([
			...
			'Recibe lo que viene,ve cuando se retira y continúa cuando la mano es liberada. -Yip Man',
                        ...
                        'El hombre bueno es maestro del hombre no bueno,y el hombre no bueno es su bien material,porque el buen maestro no tiene interés,porque a su material no le tiene apego.',
