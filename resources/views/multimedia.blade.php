<div id="social" class="section fadeIn" style="background: none repeat scroll 0% 0% #E9E9E9;
    ...
    <div class="eleven one columns ">
        <div class="one columns">
       <iframe width="400px" height="280px" src="https://www.youtube.com/embed/videoseries?list=PLsFAzrqjgQudU1zjaBzs1sb-D3eF-I9qH" frameborder="0" allowfullscreen></iframe> 
        </div>
    </div>	
    ...
    <div class="four four columns" style="bottom:150px;right: 20px;">
             @include ('pasafotos')
        </div>       
